...
//=============//
{
	...
	function makeEventWindow(world, space, x, y, z) {
		return [
			world.$Space(x + -2, y + 2, z + 0),
			world.$Space(x + -1, y + 2, z + 0),
			world.$Space(x + 0, y + 2, z + 0),
			world.$Space(x + 1, y + 2, z + 0),
			world.$Space(x + 2, y + 2, z + 0),
			
			world.$Space(x + -2, y + 1, z + 0),
			world.$Space(x + -1, y + 1, z + 0),
			world.$Space(x + 0, y + 1, z + 0),
			world.$Space(x + 1, y + 1, z + 0),
			world.$Space(x + 2, y + 1, z + 0),
			
			world.$Space(x + -2, y + 0, z + 0),
			...
			world.$Space(x + -2, y + 0, z + 2),
			world.$Space(x + -1, y + 0, z + 2),
			world.$Space(x + 0, y + 0, z + 2),
			world.$Space(x + 1, y + 0, z + 2),
			world.$Space(x + 2, y + 0, z + 2),
			
			world.$Space(x + -2, y + 0, z + 1),
			...
			*/
			...
			world.$Space(x + 0, y + 2, z + -2),
			world.$Space(x + 0, y + 2, z + -1),
			/*world.$Space(x + 0, y + 2, z + 0),*/
			world.$Space(x + 0, y + 2, z + 1),
			world.$Space(x + 0, y + 2, z + 2),
			
			world.$Space(x + 0, y + 1, z + -2),
